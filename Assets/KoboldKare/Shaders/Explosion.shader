	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float3 break33 = IN.ase_texcoord7.xyz;
				float mulTime27 = _TimeParameters.x * 0.25;
				float4 appendResult35 = (float4(break33.x , break33.y , ( break33.z + mulTime27 ) , 0.0));
				float simplePerlin3D8 = snoise( ( appendResult35 + mulTime27 ).xyz*2.0 );
				simplePerlin3D8 = simplePerlin3D8*0.5 + 0.5;
				...
				float3 Albedo = SampleGradient( gradient31, simplePerlin3D8 ).rgb;
...
/*ASEBEGIN
Version=18909
-123;164;1675;828;1813.11;13.72311;1.3;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;49;-263.3728,72.29843;Inherit;False;Constant;_Float0;Float 0;1;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
WireConnection;1;6;30;4
WireConnection;1;7;44;0
WireConnection;1;8;24;0
ASEEND*/
//CHKSM=691BADE4F695029170F2CDD33B9E4B4BD58DB278