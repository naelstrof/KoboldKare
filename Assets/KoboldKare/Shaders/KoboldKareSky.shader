...
Shader "Unlit/KoboldKareSkybox"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float temp_output_3_0_g33 = ( temp_output_228_0 - SunGradient223 );
			...
			float4 temp_output_446_0 = saturate( ( ( saturate( ( ( lerpResult36 * SunGradient223 ) + lerpResult427 ) ) + ( saturate( ( temp_output_3_0_g33 / fwidth( temp_output_3_0_g33 ) ) ) * _HDRSun ) ) - temp_cast_0 ) );
...
/*ASEBEGIN
Version=18921
302;339;2138;986;7347.868;-1219.483;1;True;True
...
Node;AmplifyShaderEditor.FunctionNode;329;-81.66835,2715.775;Inherit;False;Phase;-1;;38;4a216e25de1f86a42a8ec9514e20c5c1;0;5;1;FLOAT;0;False;4;FLOAT;0.811;False;5;FLOAT;0.33;False;6;FLOAT;1;False;7;FLOAT;0.488;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=E73E92163AE2107484FE80257A2741B68F3AD70A