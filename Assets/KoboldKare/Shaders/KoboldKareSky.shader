...
Shader "Unlit/KoboldKareSkybox"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float2 break7_g31 = id45;
			float lerpResult69_g31 = lerp( min( ( sin( ( mulTime186 + ( break7_g31.y * 100.0 ) ) ) + 1.5 ) , 1.0 ) , 1.0 , break7_g31.y);
			float temp_output_9_0_g31 = _StarVariance;
			float lerpResult50_g31 = lerp( ( _StarPinpointy * lerpResult69_g31 ) , 1000.0 , ( temp_output_9_0_g31 * break7_g31.y ));
			float temp_output_42_0_g31 = pow( ( 1.0 - saturate( voroi45 ) ) , lerpResult50_g31 );
			float lerpResult45_g31 = lerp( temp_output_42_0_g31 , ( temp_output_42_0_g31 * break7_g31.x ) , temp_output_9_0_g31);
			float time46 = 0.0;
			...
			float2 break7_g30 = id46;
			float lerpResult69_g30 = lerp( min( ( sin( ( mulTime186 + ( break7_g30.y * 100.0 ) ) ) + 1.5 ) , 1.0 ) , 1.0 , break7_g30.y);
			float temp_output_9_0_g30 = _StarVariance;
			float lerpResult50_g30 = lerp( ( _StarPinpointy * lerpResult69_g30 ) , 1000.0 , ( temp_output_9_0_g30 * break7_g30.y ));
			float temp_output_42_0_g30 = pow( ( 1.0 - saturate( voroi46 ) ) , lerpResult50_g30 );
			float lerpResult45_g30 = lerp( temp_output_42_0_g30 , ( temp_output_42_0_g30 * break7_g30.x ) , temp_output_9_0_g30);
			float lerpResult36 = lerp( ( simplePerlin3D73 * lerpResult45_g31 ) , ( simplePerlin3D73 * lerpResult45_g30 ) , saturate( sign( ( abs( (-1.0 + (temp_output_13_0 - ( -1.0 * UNITY_PI )) * (1.0 - -1.0) / (UNITY_PI - ( -1.0 * UNITY_PI ))) ) - _BlendOffset ) ) ));
			...
			float temp_output_3_0_g33 = ( ( _SunSize * _SunSize ) - SunGradient223 );
			float4 temp_output_271_0 = ( saturate( ( ( lerpResult36 * SunGradient223 ) + lerpResult249 ) ) + ( saturate( ( temp_output_3_0_g33 / fwidth( temp_output_3_0_g33 ) ) ) * _HDRSun ) );
			...
			float temp_output_2_0_g35 = _ForwardScattering;
			float temp_output_3_0_g35 = ( temp_output_2_0_g35 * temp_output_2_0_g35 );
			float dotResult327 = dot( i.viewDir , _WorldSpaceLightPos0.xyz );
			float temp_output_1_0_g34 = dotResult327;
			float temp_output_2_0_g36 = -_BackScattering;
			float temp_output_3_0_g36 = ( temp_output_2_0_g36 * temp_output_2_0_g36 );
			#ifdef _CLOUDS_ON
				float4 staticSwitch274 = ( lerpResult360 + ( temp_output_301_0 * ( _Brightness + ( ( ( ( ( 1.0 - temp_output_3_0_g35 ) / ( ( 4.0 * UNITY_PI ) * pow( ( ( temp_output_3_0_g35 + 1.0 ) - ( temp_output_2_0_g35 * 2.0 * temp_output_1_0_g34 ) ) , 1.5 ) ) ) * ( 1.0 - 0.5 ) ) + ( ( ( 1.0 - temp_output_3_0_g36 ) / ( ( 4.0 * UNITY_PI ) * pow( ( ( temp_output_3_0_g36 + 1.0 ) - ( temp_output_2_0_g36 * 2.0 * temp_output_1_0_g34 ) ) , 1.5 ) ) ) * 0.5 ) ) * _PhaseFactor ) ) ) );
			#else
...
/*ASEBEGIN
Version=18921
116;38;2560;1377;6735.216;-530.0555;1;True;True
...
Node;AmplifyShaderEditor.FunctionNode;201;-2900.167,-565.2662;Inherit;False;StarCalculation;-1;;30;afa9a5c694549284eb71b8b05e5422d7;0;6;62;FLOAT;0;False;20;FLOAT;0;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;8;FLOAT;0;False;9;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;202;-2886.912,-839.7602;Inherit;False;StarCalculation;-1;;31;afa9a5c694549284eb71b8b05e5422d7;0;6;62;FLOAT;0;False;20;FLOAT;0;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;8;FLOAT;0;False;9;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;268;-4587.354,490.2995;Inherit;False;Property;_NightColor;NightColor;7;0;Create;True;0;0;0;False;0;False;0.06966787,0.008009965,0.1132075,0;0.06966732,0.008009965,0.1132068,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;248;-2762.346,618.6172;Inherit;False;Property;_GoldenHours;GoldenHours;8;0;Create;True;0;0;0;False;0;False;0.8490566,0.4905805,0.2843539,0;0.9245283,0.4536633,0.1875216,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.FunctionNode;219;-3094.561,1774.173;Inherit;False;Step Antialiasing;-1;;33;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;329;-81.66835,2715.775;Inherit;False;Phase;-1;;34;4a216e25de1f86a42a8ec9514e20c5c1;0;5;1;FLOAT;0;False;4;FLOAT;0.811;False;5;FLOAT;0.33;False;6;FLOAT;1;False;7;FLOAT;0.488;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;274;517.5037,-245.8056;Inherit;False;Property;_CLOUDS;CLOUDS;10;0;Create;True;0;0;0;False;0;False;1;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=214993101F5DEF4245B01288569FACD83D87C086