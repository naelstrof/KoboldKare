...
Shader "Unlit/KoboldKareSkybox"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float2 break7_g29 = id45;
			float lerpResult69_g29 = lerp( min( ( sin( ( mulTime186 + ( break7_g29.y * 100.0 ) ) ) + 1.5 ) , 1.0 ) , 1.0 , break7_g29.y);
			float temp_output_9_0_g29 = _StarVariance;
			float lerpResult50_g29 = lerp( ( _StarPinpointy * lerpResult69_g29 ) , 1000.0 , ( temp_output_9_0_g29 * break7_g29.y ));
			float temp_output_42_0_g29 = pow( ( 1.0 - saturate( voroi45 ) ) , lerpResult50_g29 );
			float lerpResult45_g29 = lerp( temp_output_42_0_g29 , ( temp_output_42_0_g29 * break7_g29.x ) , temp_output_9_0_g29);
			float time46 = 0.0;
			...
			float lerpResult36 = lerp( ( simplePerlin3D73 * lerpResult45_g29 ) , ( simplePerlin3D73 * lerpResult45_g30 ) , saturate( sign( ( abs( (-1.0 + (temp_output_13_0 - ( -1.0 * UNITY_PI )) * (1.0 - -1.0) / (UNITY_PI - ( -1.0 * UNITY_PI ))) ) - _BlendOffset ) ) ));
			...
			float temp_output_3_0_g32 = ( ( _SunSize * _SunSize ) - SunGradient223 );
			...
			float temp_output_3_0_g31 = ( ( _MoonSize * _MoonSize ) - MoonGradient391 );
			float4 temp_output_271_0 = ( saturate( ( ( lerpResult36 * SunGradient223 ) + lerpResult249 ) ) + ( saturate( ( temp_output_3_0_g32 / fwidth( temp_output_3_0_g32 ) ) ) * _HDRSun ) + ( saturate( ( temp_output_3_0_g31 / fwidth( temp_output_3_0_g31 ) ) ) * _HDRMoon ) );
			...
			float temp_output_2_0_g34 = _ForwardScattering;
			float temp_output_3_0_g34 = ( temp_output_2_0_g34 * temp_output_2_0_g34 );
			float dotResult327 = dot( i.viewDir , _WorldSpaceLightPos0.xyz );
			float temp_output_1_0_g33 = dotResult327;
			float temp_output_2_0_g35 = -_BackScattering;
			float temp_output_3_0_g35 = ( temp_output_2_0_g35 * temp_output_2_0_g35 );
			#ifdef _CLOUDS_ON
				float4 staticSwitch274 = ( lerpResult360 + ( temp_output_301_0 * ( _Brightness + ( ( ( ( ( 1.0 - temp_output_3_0_g34 ) / ( ( 4.0 * UNITY_PI ) * pow( ( ( temp_output_3_0_g34 + 1.0 ) - ( temp_output_2_0_g34 * 2.0 * temp_output_1_0_g33 ) ) , 1.5 ) ) ) * ( 1.0 - 0.5 ) ) + ( ( ( 1.0 - temp_output_3_0_g35 ) / ( ( 4.0 * UNITY_PI ) * pow( ( ( temp_output_3_0_g35 + 1.0 ) - ( temp_output_2_0_g35 * 2.0 * temp_output_1_0_g33 ) ) , 1.5 ) ) ) * 0.5 ) ) * _PhaseFactor ) ) ) );
			#else
...
/*ASEBEGIN
Version=18910
29;115;1891;874;7329.181;2222.365;5.308994;True;True
...
Node;AmplifyShaderEditor.Vector3Node;377;-6669.604,1264.482;Inherit;False;Global;_SunDirection;_SunDirection;20;0;Create;True;0;0;0;False;0;False;0,-1,0;0,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.Vector3Node;422;-6546.771,1977.158;Inherit;False;Global;_SunRight;_SunRight;20;0;Create;True;0;0;0;False;0;False;1,0,0;0,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.FunctionNode;202;-2886.912,-839.7602;Inherit;False;StarCalculation;-1;;29;afa9a5c694549284eb71b8b05e5422d7;0;6;62;FLOAT;0;False;20;FLOAT;0;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;8;FLOAT;0;False;9;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;380;-3134.106,2406.609;Inherit;False;Step Antialiasing;-1;;31;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;219;-3094.561,1774.173;Inherit;False;Step Antialiasing;-1;;32;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;329;-81.66835,2715.775;Inherit;False;Phase;-1;;33;4a216e25de1f86a42a8ec9514e20c5c1;0;5;1;FLOAT;0;False;4;FLOAT;0.811;False;5;FLOAT;0.33;False;6;FLOAT;1;False;7;FLOAT;0.488;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=95C707B1F2EA8A3680D4F6B1AFFFD2A6025F857C