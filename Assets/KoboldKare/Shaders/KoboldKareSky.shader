...
Shader "Unlit/KoboldKareSkybox"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float lerpResult36 = lerp( ( simplePerlin3D73 * lerpResult45_g31 ) , ( simplePerlin3D73 * lerpResult45_g32 ) , saturate( sign( ( abs( (-1.0 + (temp_output_13_0 - ( -1.0 * UNITY_PI )) * (1.0 - -1.0) / (UNITY_PI - ( -1.0 * UNITY_PI ))) ) - _BlendOffset ) ) ));
			...
			o.Emission = saturate( ( ( saturate( ( ( lerpResult36 * SunGradient223 ) + lerpResult427 ) ) + ( saturate( ( temp_output_3_0_g33 / fwidth( temp_output_3_0_g33 ) ) ) * _HDRSun ) ) - temp_cast_0 ) ).rgb;
			o.Alpha = 1;
		}
...
/*ASEBEGIN
Version=18935
468;82;1800;930;14043.58;3773.238;12.71717;True;False
...
ASEEND*/
//CHKSM=7E43E29E95BAA059EF1917912841925824C61908