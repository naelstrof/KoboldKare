...
Shader "Unlit/KoboldKareSkybox"
{
	...
	SubShader
	{
		...
		float voronoi344( float2 v, float time, inout float2 id, inout float2 mr, float smoothness )
		{
			float2 n = floor( v );
			float2 f = frac( v );
			float F1 = 8.0;
		...
		float voronoi348( float2 v, float time, inout float2 id, inout float2 mr, float smoothness )
		{
			float2 n = floor( v );
			float2 f = frac( v );
			float F1 = 8.0;
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float2 break7_g23 = id45;
			float lerpResult69_g23 = lerp( min( ( sin( ( mulTime186 + ( break7_g23.y * 100.0 ) ) ) + 1.5 ) , 1.0 ) , 1.0 , break7_g23.y);
			float temp_output_9_0_g23 = _StarVariance;
			float lerpResult50_g23 = lerp( ( _StarPinpointy * lerpResult69_g23 ) , 1000.0 , ( temp_output_9_0_g23 * break7_g23.y ));
			float temp_output_42_0_g23 = pow( ( 1.0 - saturate( voroi45 ) ) , lerpResult50_g23 );
			float lerpResult45_g23 = lerp( temp_output_42_0_g23 , ( temp_output_42_0_g23 * break7_g23.x ) , temp_output_9_0_g23);
			float time46 = 0.0;
			...
			float2 break7_g24 = id46;
			float lerpResult69_g24 = lerp( min( ( sin( ( mulTime186 + ( break7_g24.y * 100.0 ) ) ) + 1.5 ) , 1.0 ) , 1.0 , break7_g24.y);
			float temp_output_9_0_g24 = _StarVariance;
			float lerpResult50_g24 = lerp( ( _StarPinpointy * lerpResult69_g24 ) , 1000.0 , ( temp_output_9_0_g24 * break7_g24.y ));
			float temp_output_42_0_g24 = pow( ( 1.0 - saturate( voroi46 ) ) , lerpResult50_g24 );
			float lerpResult45_g24 = lerp( temp_output_42_0_g24 , ( temp_output_42_0_g24 * break7_g24.x ) , temp_output_9_0_g24);
			float lerpResult36 = lerp( ( simplePerlin3D73 * lerpResult45_g23 ) , ( simplePerlin3D73 * lerpResult45_g24 ) , saturate( sign( ( abs( (-1.0 + (temp_output_13_0 - ( -1.0 * UNITY_PI )) * (1.0 - -1.0) / (UNITY_PI - ( -1.0 * UNITY_PI ))) ) - _BlendOffset ) ) ));
			...
			float temp_output_3_0_g25 = ( ( _SunSize * _SunSize ) - SunGradient223 );
			float4 temp_output_271_0 = ( saturate( ( ( lerpResult36 * SunGradient223 ) + lerpResult249 ) ) + ( saturate( ( temp_output_3_0_g25 / fwidth( temp_output_3_0_g25 ) ) ) * _HDRSun ) );
			...
			float2 id344 = 0;
			float2 uv344 = 0;
			float voroi344 = voronoi344( coords344, time344, id344, uv344, 0 );
			float time348 = 0.0;
			...
			float2 id348 = 0;
			float2 uv348 = 0;
			float voroi348 = voronoi348( coords348, time348, id348, uv348, 0 );
			...
			float temp_output_2_0_g27 = _ForwardScattering;
			float temp_output_3_0_g27 = ( temp_output_2_0_g27 * temp_output_2_0_g27 );
			float dotResult327 = dot( i.viewDir , _WorldSpaceLightPos0.xyz );
			float temp_output_1_0_g26 = dotResult327;
			float temp_output_2_0_g28 = -_BackScattering;
			float temp_output_3_0_g28 = ( temp_output_2_0_g28 * temp_output_2_0_g28 );
			#ifdef _CLOUDS_ON
				float4 staticSwitch274 = ( lerpResult360 + ( temp_output_301_0 * ( _Brightness + ( ( ( ( ( 1.0 - temp_output_3_0_g27 ) / ( ( 4.0 * UNITY_PI ) * pow( ( ( temp_output_3_0_g27 + 1.0 ) - ( temp_output_2_0_g27 * 2.0 * temp_output_1_0_g26 ) ) , 1.5 ) ) ) * ( 1.0 - 0.5 ) ) + ( ( ( 1.0 - temp_output_3_0_g28 ) / ( ( 4.0 * UNITY_PI ) * pow( ( ( temp_output_3_0_g28 + 1.0 ) - ( temp_output_2_0_g28 * 2.0 * temp_output_1_0_g26 ) ) , 1.5 ) ) ) * 0.5 ) ) * _PhaseFactor ) ) ) );
			#else
...
/*ASEBEGIN
Version=18712
1206;73;713;936;-59.67694;667.9879;1;True;False
...
Node;AmplifyShaderEditor.NormalizeNode;7;-4745.019,-1403.577;Inherit;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.WorldSpaceLightDirHlpNode;215;-6074.077,1228.509;Inherit;False;False;1;0;FLOAT;0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.NormalizeNode;218;-5840.132,1048.077;Inherit;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.NormalizeNode;246;-3409.724,1104.531;Inherit;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;223;-5208.132,1125.595;Inherit;False;SunGradient;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.VoronoiNode;344;-432.5872,1591.117;Inherit;False;0;0;1;0;1;False;1;False;False;4;0;FLOAT2;0,0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;0;False;3;FLOAT;0;FLOAT2;1;FLOAT2;2
...
Node;AmplifyShaderEditor.VoronoiNode;46;-3403.671,-537.8101;Inherit;False;0;0;1;0;1;False;1;False;False;4;0;FLOAT2;0,0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;0;False;3;FLOAT;0;FLOAT2;1;FLOAT2;2
...
Node;AmplifyShaderEditor.VoronoiNode;45;-3422.465,-1310.074;Inherit;False;0;0;1;0;1;False;1;False;False;4;0;FLOAT2;0,0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;0;False;3;FLOAT;0;FLOAT2;1;FLOAT2;2
...
Node;AmplifyShaderEditor.VoronoiNode;348;-402.1678,1850.754;Inherit;False;0;0;1;0;1;False;1;False;False;4;0;FLOAT2;0,0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;0;False;3;FLOAT;0;FLOAT2;1;FLOAT2;2
...
Node;AmplifyShaderEditor.FunctionNode;201;-2900.167,-565.2662;Inherit;False;StarCalculation;-1;;24;afa9a5c694549284eb71b8b05e5422d7;0;6;62;FLOAT;0;False;20;FLOAT;0;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;8;FLOAT;0;False;9;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;268;-4587.354,490.2995;Inherit;False;Property;_NightColor;NightColor;7;0;Create;True;0;0;0;False;0;False;0.06966787,0.008009965,0.1132075,0;0.06966744,0.008009965,0.113207,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.FunctionNode;202;-2886.912,-839.7602;Inherit;False;StarCalculation;-1;;23;afa9a5c694549284eb71b8b05e5422d7;0;6;62;FLOAT;0;False;20;FLOAT;0;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;8;FLOAT;0;False;9;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;248;-2762.346,618.6172;Inherit;False;Property;_GoldenHours;GoldenHours;8;0;Create;True;0;0;0;False;0;False;0.8490566,0.4905805,0.2843539,0;0.9245283,0.4536633,0.1875217,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.FunctionNode;219;-3093.561,1774.173;Inherit;False;Step Antialiasing;-1;;25;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;273;-3045.833,2062.284;Inherit;False;Property;_HDRSun;HDRSun;9;0;Create;True;0;0;0;False;0;False;2;3;1;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;331;-440.4004,3096.78;Inherit;False;Property;_PhaseFactor;Phase Factor;15;0;Create;True;0;0;0;False;0;False;0.488;0.6705882;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;271;-883.2845,-184.589;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;329;-81.66835,2715.775;Inherit;False;Phase;-1;;26;4a216e25de1f86a42a8ec9514e20c5c1;0;5;1;FLOAT;0;False;4;FLOAT;0.811;False;5;FLOAT;0.33;False;6;FLOAT;1;False;7;FLOAT;0.488;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;274;517.5037,-245.8056;Inherit;False;Property;_CLOUDS;CLOUDS;10;0;Create;True;0;0;0;False;0;False;1;0;1;True;;Toggle;2;Key0;Key1;Create;True;True;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;161;956.373,-302.9604;Float;False;True;-1;0;ASEMaterialInspector;0;0;Unlit;Unlit/KoboldKareSkybox;False;False;False;False;True;True;True;True;True;True;True;True;False;False;True;True;False;False;False;False;False;Off;2;False;-1;0;False;-1;False;0;False;-1;0;False;-1;False;0;Custom;0;True;False;0;True;Background;;Background;All;14;all;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;False;2;5;False;-1;10;False;-1;0;0;False;-1;0;False;-1;1;False;-1;1;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;3;-1;-1;-1;1;PreviewType=Skybox;False;0;0;False;-1;-1;0;False;-1;1;Include;Clouds.cginc;False;;Custom;0;0;False;0.1;False;-1;0;False;-1;False;15;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=352027FE971A7D6976F0A98FC99AC56D74CAB9A1