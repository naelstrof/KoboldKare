	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float fresnelNode16_g62 = ( 0.5 + 1.0 * pow( max( 1.0 - fresnelNdotV16_g62 , 0.0001 ), 2.0 ) );
...
/*ASEBEGIN
Version=18935
696;658;1528;724;336.3308;45.6066;1;True;False
...
ASEEND*/
//CHKSM=BED929F9083773DB10EFB6EBA090BBE888EDA49D