...
namespace Photon.Pun
{
    ...
    public static partial class PhotonNetwork
    {
        ...
        [Obsolete("Use NetworkManager.Instantiate, otherwise it won't be saved properly")]
        ...
        [Obsolete("Use NetworkManager.InstantiateRoomObject, otherwise it won't be saved properly")]
        ...
        [Obsolete("Use NetworkManager.Destroy instead! Otherwise it won't get saved properly.")]
