    ...
    public class TMP_Settings : ScriptableObject
    {
        ...
        public static TMP_Settings instance
        {
            get
            {
                if (TMP_Settings.s_Instance == null)
                {
                    ...
                    TMP_Settings.s_Instance = Addressables.LoadAssetAsync<TMP_Settings>("TextSettings").WaitForCompletion();
        ...
        public static TMP_Settings LoadDefaultSettings()
        {
            if (s_Instance == null)
            {
                ...
                TMP_Settings settings = Addressables.LoadAssetAsync<TMP_Settings>("TextSettings").WaitForCompletion();
                if (settings != null)
                    s_Instance = settings;
            }
