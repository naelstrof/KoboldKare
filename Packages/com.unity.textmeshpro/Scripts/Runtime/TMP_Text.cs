                ...
                switch (m_xmlAttribute[0].nameHashCode)
                {
                    ...
                    case 28511: // <FONT>
                        ...
                        if (tempFont == null)
                        {
                            ...
                            if (tempFont == null)
                            {
                                ...
                                tempFont = Addressables.LoadAssetAsync<TMP_FontAsset>(new string(m_htmlTag, m_xmlAttribute[0].valueStartIndex, m_xmlAttribute[0].valueLength)).WaitForCompletion();
                            }
                        ...
                        else if (materialAttributeHashCode == 103415287 || materialAttributeHashCode == 72669687) // using material attribute
                        {
                            ...
                            else
                            {
                                ...
                                tempMaterial = Addressables.LoadAssetAsync<Material>(new string(m_htmlTag, m_xmlAttribute[1].valueStartIndex, m_xmlAttribute[1].valueLength)).WaitForCompletion();
                    ...
                    case 72669687: // <MATERIAL>
                        ...
                        else
                        {
                            ...
                            tempMaterial = Addressables.LoadAssetAsync<Material>(new string(m_htmlTag, m_xmlAttribute[0].valueStartIndex, m_xmlAttribute[0].valueLength)).WaitForCompletion();
                    ...
                    case 69403544:  // <GRADIENT>
                        ...
                        else
                        {
                            ...
                            if (tempColorGradientPreset == null)
                            {
                                ...
                                tempColorGradientPreset = Addressables.LoadAssetAsync<TMP_ColorGradient>( new string(m_htmlTag, m_xmlAttribute[0].valueStartIndex, m_xmlAttribute[0].valueLength)).WaitForCompletion();
                            }
                        ...
                        if (m_xmlAttribute[0].valueType == TagValueType.None || m_xmlAttribute[0].valueType == TagValueType.NumericalValue)
                        {
                            ...
                            else if (m_defaultSpriteAsset == null)
                            {
                                if (TMP_Settings.defaultSpriteAsset != null)
                                    ...
                                    m_defaultSpriteAsset = Addressables.LoadAssetAsync<TMP_SpriteAsset>("Default Sprite Asset").WaitForCompletion();
                        ...
                        else
                        {
                            ...
                            else
                            {
                                ...
                                if (tempSpriteAsset == null)
                                {
                                    ...
                                    if (tempSpriteAsset == null) {
                                        //tempSpriteAsset = Resources.Load<TMP_SpriteAsset>(
                                            //TMP_Settings.defaultSpriteAssetPath + new string(m_htmlTag,
                                                //m_xmlAttribute[0].valueStartIndex, m_xmlAttribute[0].valueLength));
                                        tempSpriteAsset = Addressables.LoadAssetAsync<TMP_SpriteAsset>(new string(m_htmlTag, m_xmlAttribute[0].valueStartIndex, m_xmlAttribute[0].valueLength)).WaitForCompletion();
                                    }
                                }
